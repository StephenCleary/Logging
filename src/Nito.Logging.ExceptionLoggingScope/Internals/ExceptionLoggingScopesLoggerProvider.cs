...
/// </summary>
public sealed class ExceptionLoggingScopesLoggerProvider(ILoggerProvider innerLoggerProvider) : ILoggerProvider, ISupportExternalScope
{
	...
	void ISupportExternalScope.SetScopeProvider(IExternalScopeProvider scopeProvider) =>
		((ISupportExternalScope)_innerLoggerProvider).SetScopeProvider(scopeProvider);
