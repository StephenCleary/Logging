// Copied from https://github.com/dotnet/runtime/blob/664eda9afd07db4a1998bb333512ba9def3ec18f/src/libraries/Microsoft.Extensions.Logging/src/LoggerRuleSelector.cs
    ...
    internal static class LoggerRuleSelector
    {
        ...
        private static bool IsBetter(LoggerFilterRule rule, LoggerFilterRule? current, string? logger, string category)
        {
            ...
            if (categoryName != null)
            {
                ...
                {
                    throw new InvalidOperationException("More than one wildcard is not allowed in a rule.");
                }
